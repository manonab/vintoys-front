  ...
  return (
    <div className="justify-items-center">
      <div className="w-full max-h-screen flex flex-col w-2/4 mx-auto mt-20">
        ...
        <input
          className="border w-1/4 p-2 my-3	border-1 rounded border-dotted mx-auto font-baumans"
        ...
        />
        <input
          className="border w-1/4 p-2 my-3 rounded border-1 border-dotted mx-auto font-baumans"
